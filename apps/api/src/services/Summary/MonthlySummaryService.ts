...
// import { Account, Budget, ScheduledTransaction, Transaction, User, Category } from 'entities';
...
//     expectedTransactions: ScheduledTransaction[],
//     budgets: Budget[],
//   ): CategorySummary[] {
...
//   private latestTransaction(latest: Date, current: Transaction | ScheduledTransaction): Date {
