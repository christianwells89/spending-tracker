...
export class Initial1591584218028 implements MigrationInterface {
    name = 'Initial1591584218028'
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("CREATE TABLE `budget` (`id` int NOT NULL AUTO_INCREMENT, `createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `uid` varchar(255) NOT NULL, `name` varchar(255) NOT NULL, `currency` enum ('aud', 'usd') NOT NULL, `timezone` varchar(255) NULL, `userId` int NOT NULL, UNIQUE INDEX `IDX_9b036dd5b8472b3e57a9a41514` (`uid`), PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
